// Generated from c:/Users/NASA/comp2024-10e/src/main/antlr/comp2024/Javamm.g4 by ANTLR 4.13.1
...
public class JavammParser extends Parser {
	...
	public static final int
		...
		MULTI_COMMENT=47, INTEGER=48, ID=49, STRING=50;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"MULTI_COMMENT", "INTEGER", "ID", "STRING"
		};
	}
	...
	public final MethodDeclarationContext methodDeclaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1976923870255744L) != 0)) {
					{
					setState(110);
					_errHandler.sync(this);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1976923870200448L) != 0)) {
					{
					{
					setState(162);
					statement();
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1976923786314240L) != 0)) {
					{
					setState(220);
					parameter();
					}
