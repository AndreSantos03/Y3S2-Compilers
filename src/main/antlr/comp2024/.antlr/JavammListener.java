...
public interface JavammListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code MethDeclaration}
	 * labeled alternative in {@link JavammParser#methodDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterMethDeclaration(JavammParser.MethDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by the {@code MethDeclaration}
	 * labeled alternative in {@link JavammParser#methodDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitMethDeclaration(JavammParser.MethDeclarationContext ctx);
	/**
	 * Enter a parse tree produced by the {@code MainMethDeclaration}
	 * labeled alternative in {@link JavammParser#methodDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterMainMethDeclaration(JavammParser.MainMethDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by the {@code MainMethDeclaration}
	 * labeled alternative in {@link JavammParser#methodDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitMainMethDeclaration(JavammParser.MainMethDeclarationContext ctx);
	/**
